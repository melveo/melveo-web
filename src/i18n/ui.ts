...
export const ui = {
  cs: {
    ...
    */
    ...
    'help.hub.metaDescription': 'Návody k instalaci Melveo, založení týmu, připojení hráče, rannímu check-inu a platbám.',
  ...
  en: {
    ...
    'help.hub.metaDescription': 'Guides to installing Melveo, creating a team, joining as a player, morning check-ins, and billing.',
