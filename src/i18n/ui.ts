...
export const ui = {
  cs: {
    ...
    */
    ...
    'help.match.step1.body': 'V hlavní navigaci klepni na Aktivity. Tady spouštíš trénink nebo zápas podle toho, co právě začíná.',
    'help.match.step2.title': 'Spusť zápas',
    'help.match.step2.body': 'Po spuštění se otevře živá obrazovka se skóre proti pojmenovanému soupeři.',
    'help.match.liveTitle': 'Zapisuj dění přímo ze živé obrazovky',
    'help.match.live1.title': 'Skóre a počet akcí',
    'help.match.live1.body': 'Vidíš průběžné skóre i počet zapsaných akcí.',
    'help.match.live2.title': 'Zapiš, co se stalo',
    'help.match.live2.body': 'Můžeš zapsat gól, střelu, žlutou kartu, červenou kartu, 2 minuty nebo 7 metrů.',
    'help.match.live3.title': 'Sleduj volitelný tep',
    'help.match.live3.body': 'U každého vidíš „Můj tep“ v bpm. Bez připojeného hrudního pásu Polar aplikace čeká na pás, ale zápas běží dál.',
  ...
  en: {
    ...
    'help.match.step2.body': 'The live screen opens with the score against the named opponent.',
    'help.match.liveTitle': 'Log the match from the live screen',
    'help.match.live1.title': 'Score and action count',
    'help.match.live1.body': 'You see the running score and the number of logged actions.',
    'help.match.live2.title': 'Log what happened',
    'help.match.live2.body': 'You can log a goal, shot, yellow card, red card, 2-minute suspension, or 7-metre throw.',
    'help.match.live3.title': 'See optional heart rate',
    'help.match.live3.body': 'For each person, “My heart rate” appears in bpm. Without a connected Polar chest strap, the app waits for the strap, but the match still runs.',
